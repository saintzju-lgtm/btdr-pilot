...
import pytz
from scipy.stats import norm, t as student_t  # 新增 Student-t
...
buy_prob = max(min((1 - student_t.cdf(z_buy, df=5)) * 100 * 2, 95), 5)  # ✅ Student-t
...
sell_prob = max(min((1 - student_t.cdf(z_sell, df=5)) * 100 * 2, 95), 5)  # ✅ Student-t
